...
"[project]/app/api/advisories/alerts/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    const [data, error] = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withErrorBoundary"])(async ()=>{
        ...
        const severity = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseEnumParam"])(searchParams.get("severity"), [
            "INFO",
            "WARNING",
            "CRITICAL",
            "EMERGENCY"
        ]);
        const alertCategory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseEnumParam"])(searchParams.get("category"), [
            "WEATHER",
            "HEALTH",
            "SECURITY",
            "TRANSPORT",
        ...
        const includeResolved = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseBooleanParam"])(searchParams.get("resolved"));
        const includeExpired = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseBooleanParam"])(searchParams.get("expired"));
        // ── Build WHERE clause ──────────────────────────────────────────────
        const now = new Date();
        const where = {
            isActive: true
        ...
        // ── Execute query ───────────────────────────────────────────────────
        const [alerts, totalCount] = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction([
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].travelAlert.findMany({
                where,
                orderBy: [
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].travelAlert.count({
                where
            })
        ]);
        // ── Compute severity summary for dashboard display ──────────────────
        const severityCounts = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].travelAlert.groupBy({
            by: [
                "severity"
            ],
            where: {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiPaginatedSuccess"])(data.alerts, data.totalCount, data.page, data.pageSize);
}
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, false);}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__10mt0za._.js.map